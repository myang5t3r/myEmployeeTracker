...
async function queryEmployees(){
    ...
    await new Promise(resolve => {
        // Query database
        sql = "SELECT employees.id, employees.first_name, employees.last_name, roles.title, departmentName, roles.salary, manager_id FROM employees INNER JOIN roles ON employees.role_id = roles.id INNER JOIN departments ON roles.department_id = departments.id"
